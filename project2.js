...
class MeshDrawer {
	...
	constructor() {
		...
		// Task 2: Initialize lighting-related uniforms
	...
	setTexture(img) {
		...
		if (isPowerOf2(img.width) && isPowerOf2(img.height)) {
			 ...
			 */
			// Set wrapping to clamp to edge and filtering to linear for NPOT textures.
...
void main() {
    ...
    vec3 lightDirection = normalize(vec3(lightPos.x, lightPos.y, 1.0));
    ...
    if (enableLighting) {
        finalColor = finalColor * (ambient + diff);
    }
